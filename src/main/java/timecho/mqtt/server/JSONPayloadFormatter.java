...
public class JSONPayloadFormatter implements PayloadFormatter {
  ...
  public List<Message> format(ByteBuf payload) {
    ...
    try {
      ...
      message.setDevice("not a json device");
      message.setTimestamp(System.currentTimeMillis());
      message.setMeasurements(Collections.singletonList("not a json measurement"));
      message.setValues(Collections.singletonList("not a json value"));
